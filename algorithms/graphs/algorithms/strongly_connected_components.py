...
def number_of_strongly_connected_components(adj, adj_reverse):
    ...
    def explore(u):
        nonlocal scc_num # nonlocal enables updating scc_num outside of explore
        visited[u] = True
...
if __name__ == '__main__':
    '''
    Computes the number of strongly connected components of a given 
    directed graph with n vertices and m edges.
    
    Good job! (Max time used: 0.13/5.00, max memory used: 12312576/536870912.)
    '''
